...
# De hecho, la teoría nos dice que cubriremos ??X el 95% del tiempo. 
# Debido a que tenemos acceso a los datos de la población, 
...
## Tamaño de muestra pequeño y el CLT
## Para N = 30, el CLT funciona muy bien. 
## Sin embargo, si N = 5, 
## ¿funcionan estos intervalos de confianza también? 
## Utilizamos el CLT para crear nuestros intervalos, y 
## con N = 5 puede que no sea una aproximación tan útil. 
## Podemos confirmar esto con una simulación:
...
## A pesar de que los intervalos son más grandes 
## (estamos dividiendo por 5 - ??? en lugar de 30 ?????? ???), 
## vemos muchos más intervalos que no cubren ??X. 
## Esto se debe a que el TCL nos dice incorrectamente que la distribución de la media (comida) 
## es aproximadamente normal cuando, de hecho, tiene una cola más gruesa 
## (las partes de la distribución van a ± ???). 
## Este error nos afecta en el cálculo de Q, que asume una distribución normal y usa qnorm. 
## La distribución t podría ser más apropiada. 
